  ...
  const mainCertifications = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1589395937857-d1a6d14d5b44?w=400&h=300&fit=crop'
    },
    {
      icon: FiShield,
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1578662996442-374dcbcb630e?w=400&h=300&fit=crop'
    }
  ];
              ...
              {certificationProcess.map((process, index) => (
                ...
                >
                  ...
                  <div className="lg:w-2/12 flex justify-center my-8 lg:my-0 lg:order-2">
                    <div className="bg-primary text-white w-16 h-16 rounded-full flex items-center justify-center text-xl font-bold shadow-lg">
                      {process.step}
                    </div>
                  </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Certificate Gallery</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'Halal Certificate', image: 'https://images.unsplash.com/photo-1589395937857-d1a6d14d5b44?w=400&h=500&fit=crop' },
              { title: 'Export License', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=400&h=500&fit=crop' },
              { title: 'Health Certificate', image: 'https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=400&h=500&fit=crop' },
              { title: 'Quality Certification', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=400&h=500&fit=crop' },
              { title: 'Facility License', image: 'https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=400&h=500&fit=crop' },
              { title: 'Trade License', image: 'https://images.unsplash.com/photo-1578662996442-374dcbcb630e?w=400&h=500&fit=crop' }
            ].map((cert, index) => (
              <motion.div
                key={index}
